...
public class OrderStatus {
     ...
     * 获取订单ID;对应订单表的主键id
     *
     * @return orderId - 订单ID;对应订单表的主键id
     */
     ...
     *
     * @return createdTime - 订单创建时间;对应[10:待付款]状态
     */
     ...
     *
     * @return payTime - 支付成功时间;对应[20:已付款，待发货]状态
     */
     ...
     *
     * @return deliverTime - 发货时间;对应[30：已发货，待收货]状态
     */
     ...
     *
     * @return successTime - 交易成功时间;对应[40：交易成功]状态
     */
     ...
     *
     * @return closeTime - 交易关闭时间;对应[50：交易关闭]状态
     */
     ...
     *
     * @return commentTime - 留言时间;用户在交易成功后的留言时间
     */
