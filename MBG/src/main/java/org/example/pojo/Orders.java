...
public class Orders {
     ...
     * 获取邮费;默认可以为零，代表包邮
     *
     * @return postAmount - 邮费;默认可以为零，代表包邮
     */
     ...
     *
     * @return isComment - 买家是否评价;1：已评价，0：未评价
     */
     ...
     * 获取逻辑删除状态;1: 删除 0:未删除
     *
     * @return isDelete - 逻辑删除状态;1: 删除 0:未删除
     */
